class ConsoleNotificationService {
  notifyTransferCompleted({ sender, receiver, fromAccountId, amount }) {
    this.logDebitNotification(sender, fromAccountId, amount);
    this.logCreditNotification(receiver, fromAccountId, amount);
  }

  logDebitNotification(sender, fromAccountId, amount) {
  ...
  logCreditNotification(receiver, fromAccountId, amount) {
